...
public class AccountDtoToAccountModelConverter implements Converter<AccountDto,Account> {

	@Override
	public Account convert(AccountDto source) {
		return new Account(source.getName(), source.getDescription(), source.getType(), source.getStatus(), source.getBalance());
	}
